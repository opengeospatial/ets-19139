...
public class VerifyURIUtils {
    ...
    @Test
    public void resolveClasspathResource() throws SAXException, IOException, Exception,
            URISyntaxException {
    ...
    @Test
    public void resolveFileRefWithXInclude() throws SAXException, IOException, Exception,
            URISyntaxException {
