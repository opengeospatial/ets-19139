...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:geonet="http://www.fao.org/geonetwork" xmlns:iso="http://purl.oclc.org/dsdl/schematron" schemaVersion="ISO19757-3" queryBinding="xslt2">
  ...
  <!-- Update Nov 12, 2012: commented out test for content in all gml elements, added tests for EX_GeographicBoundingBox, added test for gco:Date format -->
  <pattern>
  ...
  <pattern>
    <title>DirectPositionType</title>
  ...
  <pattern>
    ...
    <rule context="//gco:Date">
      <report test="string-length(.) != 10">Date format must be YYYY-MM-DD (10 characters)</report>      
    </rule>
  </pattern>  
  <pattern>
