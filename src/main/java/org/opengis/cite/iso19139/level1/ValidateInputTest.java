...
public class ValidateInputTest {
    ...
    /**
     * Validates whether the given input file is an XML file (based on its extension OR file content)
     */
    
    @Test (groups = { "inputvalidation" },dependsOnMethods = "validateXMLPath")
