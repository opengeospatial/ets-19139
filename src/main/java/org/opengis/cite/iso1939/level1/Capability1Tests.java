package org.opengis.cite.iso1939.level1;

import java.io.IOException;
import java.net.URL;
import javax.xml.transform.Source;
import javax.xml.transform.dom.DOMSource;
import org.opengis.cite.iso1939.ErrorMessage;
import org.opengis.cite.iso1939.ErrorMessageKeys;
import org.opengis.cite.iso1939.SuiteAttribute;
...
public class Capability1Tests {
     ...
     * {@link org.opengis.cite.iso1939.SuiteAttribute#TEST_SUBJECT} should
    ...
    public void docIsValidAtomFeed() throws SAXException, IOException {
        URL schemaRef = getClass().getResource(
                "/org/opengis/cite/beta/rnc/atom.rnc");
